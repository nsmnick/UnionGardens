<template>
    ...
    >
		...
		<li v-for="page in pages" :key="page.id" :class="[pageClass, page.selected ? activeClass : '', page.disabled ? disabledClass : '', page.breakView ? breakViewClass: '']">
